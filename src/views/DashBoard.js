        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-service-cap mb-30">
                        <div class="service-img">
                            <img src="assets/img/pictures/chairs/chair1.jpg" alt=""/>
                        </div>
                        <div class="service-cap">
                            <h4><a href="services_details.htmlaa">Furniture Works</a></h4>
                            <a href="services_details.html" class="more-btn"></a>
                        </div>
                        <div class="service-icon">
                            <img src="assets/img/icon/services_icon1.png" alt=""/>
                        ...
                        <div class="properties__button">
                            ...
                            <nav> 
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-last-techno" data-toggle="tab" href="#nav-technology" role="tab" aria-controls="" aria-selected="false">Tiling</a>
                                     <a class="nav-item nav-link" id="nav-home-fur" data-toggle="tab" href="#nav-fur" role="tab" aria-controls="" aria-selected="false">Furniture Works</a>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="tab-content active" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade  show" id="nav-fur" role="tabpanel" aria-labelledby="nav-home-fur">           
                            <div class="project-caption">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/chairs/chair2.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/chairs/chair3.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/chairs/chair4.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/chairs/chair5.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                               <img src="assets/img/pictures/chairs/chair6.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                               <img src="assets/img/pictures/chairs/chair7.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                               <img src="assets/img/pictures/chairs/chair8.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                               <img src="assets/img/pictures/chairs/chair9.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                               <img src="assets/img/pictures/chairs/chair10.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                            ...
                            <div class="project-caption">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/roofing/roof16.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/roofing/roof17.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                        ...
                        {/* Tilling */}
                         ...
                         <div class="tab-pane fade" id="nav-technology" role="tabpanel" aria-labelledby="nav-techno">
                            <div class="project-caption">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/tiling/tiling1.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/tiling/tiling2.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/tiling/tiling3.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="assets/img/pictures/tiling/tiling4.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                            ...
                            <div class="project-caption">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door21.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door22.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door23.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door24.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door25.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door26.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door27.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door28.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                            <img src="assets/img/pictures/doors/door29.jpg" alt=""/>
                                            </div>
                                            <div class="project-cap">
                                                {/* <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                               <h4><a href="project_details.html">Floride Chemicals</a></h4>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/pictures/Roofing.jpg" alt=""/>
                        </div>
                        <div class="team-caption">
                            <span>Roofing</span>
                            <h3>Mark Kojo Danso</h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/pictures/Tiling.jpg" alt=""/>
                        </div>
                        <div class="team-caption">
                            <span>Tiling</span>
                            <h3>Anthony Twiaku</h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
      ...
      <div class="single-testimonial">
        <div class="testimonial-caption">
          <div className="testimonial-top-cap">
            ...
            <p>
              Maskaf Construction delivered exactly what they promised — and more. The quality of work was top-notch, and their team was highly professional. The best part? I was able to pay in flexible installments without any stress. Highly recommend them!
            </p>
          </div>
          <div class="testimonial-founder d-flex align-items-center">
            <div class="founder-text">
              <span>Kwame Boateng</span>
              <p>Homeowner, Kumasi</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="single-testimonial">
        <div class="testimonial-caption">
          <div className="testimonial-top-cap">
            ...
            <p>
              I used Maskaf Construction for my shop renovation. They were efficient, transparent, and delivered great results. The installment payment plan made it easy for me to stay within budget. I’ll definitely work with them again in the future.
            </p>
          </div>
          <div class="testimonial-founder d-flex align-items-center">
            <div class="founder-text">
              <span>Akosua Mensah</span>
              <p>Shop Owner, Accra</p>
            </div>
          </div>
        </div>
      </div>
